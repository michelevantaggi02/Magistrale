...
Il piazzamento dei poli e degli zeri può essere usato per progettare dei filtri semplici, come i filtri di primo ordine __smoothers__, __notch__ e __resonator__.
...
Per determinare $a$ possiamo basarci sull valore desiderato della soglia, e quindi anche sulla specifica della durata del transitorio che vogliamo:
...
$$
a = \varepsilon^{1/n_{\text{eff}}} = (0.01)^{1/20}
$$
