...
Questa equazione è possibile come identità in $z^{-1}$, il grado del __polinomio al numeratore__ deve essere __strettamente minore__ del grado $n$ del polinomio al denominatore.
